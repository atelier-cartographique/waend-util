...
export declare namespace dom {
    const isKeyCode: (kc: KeyCode) => (event: KeyboardEvent) => boolean;
    enum KeyCode {
        BACKSPACE = 8,
        TAB = 9,
        ENTER = 13,
    ...
    const appendText: (text: string) => (node: Element) => Text;
    function setAttributes(elem: Element, attrs: any): Element;
    function addClass(elem: Element, c: string): void;
    function toggleClass(elem: Element, c: string): void;
    function hasClass(elem: Element, c: string): boolean;
    function removeClass(elem: Element, c: string): void;
    function emptyElement(elem: Node): Node;
    function removeElement(elem: Node, keepChildren?: boolean): Node;
