...
exports.createElement = (tagName) => {
    return (document.createElement(tagName));
};
exports.DIV = () => {
    return exports.createElement('div');
};
exports.SPAN = () => {
    return exports.createElement('span');
};
exports.A = () => {
    return exports.createElement('a');
};
exports.INPUT = () => {
    return exports.createElement('input');
};
exports.TEXTAREA = () => {
    return exports.createElement('textarea');
};
exports.CANVAS = () => {
    return exports.createElement('canvas');
};
exports.IMG = () => {
    return exports.createElement('img');
};
exports.LABEL = () => {
    return exports.createElement('label');
};
exports.appendText = (text) => (node) => {
...
function makeButton(label, attrs, callback) {
    const button = exports.DIV();
    const labelElement = exports.SPAN();
...
function makeInput(options, callback) {
    const inputElement = exports.INPUT();
    const labelElement = exports.LABEL();
    const wrapper = exports.DIV();
...
exports.eventPreventer = eventPreventer;
function getDomForModel(model, key, tagName = 'div', className) {
    ...
    exports.appendText(getValue(key))(element);
...
exports.getDomForModel = getDomForModel;
